              ...
              .h/+/y`hhs                 yyh`y/+/h.
               `hd/::-+.                 .+-::/dy`
                 /hs+/::.--           --.::/+sh:
                   :hds+/-`           `-/+sdh:
                     `/xmM+           +Mmx/`
                        \033[94m[\033[101m\033[97m- Aris Rahmadani -\033[0m\033[94m]

               \033[91m.\033[97m__=\033[94m[\033[97m Coded by \033[92m TREVOR-X403 \033[94m]\033[97m=__\033[91m.
...
def animated_marker():
    widgets = ['\033[94m[\033[97m#\033[94m]\033[97mLoading Pinjem Dulu Seratus: ', progressbar.AnimatedMarker()]
